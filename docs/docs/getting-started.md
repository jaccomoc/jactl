...
To get the JAR, download it from [https://repo1.maven.org/maven2/io/jactl/jactl-repl/2.5.2/jactl-repl-2.5.2.jar](https://repo1.maven.org/maven2/io/jactl/jactl-repl/2.5.2/jactl-repl-2.5.2.jar)
and then run it directly:
```shell
$ java -jar jactl-repl-2.5.2.jar
> 10.map{ it + 1 }.sum()
55
```
