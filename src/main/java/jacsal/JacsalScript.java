...
/**
 * A compiled JacsalScript.
 */
public class JacsalScript {

  private BiConsumer<Map<String,Object>,Consumer<Object>> script;
  private JacsalContext jacsalContext;

  JacsalScript(JacsalContext jacsalContext, BiConsumer<Map<String,Object>,Consumer<Object>> script) {
  ...
  public Object runSync(Map<String,Object> globals) {
    ...
    jacsalContext.scheduleEvent(null, () -> run(globals, future::complete));
    try {
