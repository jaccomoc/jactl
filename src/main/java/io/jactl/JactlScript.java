...
public class JactlScript {
   ...
   */
  public void run(JactlMap globals, BufferedReader input, PrintStream output, Consumer<Object> completion) {
   ...
   * @return the result returned from the script
   */
  public Object runSync(JactlMap globals, BufferedReader input, PrintStream output) {
