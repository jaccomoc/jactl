...
public class RuntimeState {
  ...
  public static JactlMap getCurrentGlobals() {
  ...
  public static void setState(JactlMap globals, BufferedReader input, PrintStream output) {
    RuntimeState state = getState();
    state.input = input;
    state.output = output;
