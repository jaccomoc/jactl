...
import pragma.runtime.Location;

public class PragmaError extends RuntimeException {
   ...
   */
  public PragmaError(String error, Location location, boolean captureStackTrace) {
    this(error, location, captureStackTrace, null);
  }

  public PragmaError(String error, Location location, boolean captureStackTrace, Throwable cause) {
