...
public class PragmaContext {
  ...
  public static PragmaContext create() {
    return new PragmaContext();
  }

  private PragmaContext() {}

  Class<?> loadClass(String name, byte[] bytes) {
    return classLoader.loadClass(name, bytes);
  }

  public PragmaContext eventLoopThreads(int threads)     { this.eventLoopThreads   = threads; return this; }
  public PragmaContext replMode(boolean mode)            { this.replMode           = mode;    return this; }
  public PragmaContext maxScale(int scale)               { this.maxScale           = scale;   return this; }
  public PragmaContext evaluateConstExprs(boolean value) { this.evaluateConstExprs = value;   return this; }
  public PragmaContext debug(boolean value)              { this.debug              = value;   return this; }

  public PragmaContext build() {
  ...
  public void scheduleEvent(Object threadContext, Runnable event) {
    if (!initialised) {
      throw new IllegalStateException("PragmaContext not initialised. build() has not been invoked.");
    }
