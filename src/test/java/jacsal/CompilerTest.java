...
class CompilerTest extends BaseTest {
  ...
  @Test public void simpleConstExpressions() {
    ...
    testError("1/0.0", "divide by zero");
    testError("1%0", "divide by zero");
    testError("1 mod 0", "divide by zero");
    test("1.0D%0", Double.NaN);
    test("-1.0D%0", Double.NaN);
    test("1.0D mod 0", Double.NaN);
    test("-1.0D mod 0", Double.NaN);
    testError("1L%0", "divide by zero");
    testError("1.0%0", "divide by zero");
    testError("1%0.0", "divide by zero");
    testError("1L mod 0", "divide by zero");
    testError("1.0 mod 0", "divide by zero");
    testError("1 mod 0.0", "divide by zero");
    test("1 + 2", 3);
    test("1 - 2", -1);
    test("1 - -2", 3);
    test("2 * 3", 6);
    ...
    test("8.0D % 5.0D", 3D);
    test("-8.0D % 5.0D", -3D);
    test("8.0D mod 5.0D", 3D);
    test("-8.0D mod 5.0D", 2D);
    test("8.0D % -5.0D", 3D);
    test("-8.0D % -5.0D", -3D);
    test("8.0D mod -5.0D", -2D);
    test("-8.0D mod -5.0D", -3D);
    ...
    test("8.0 % 5.0", "#3.0");
    test("-8.0 % 5.0", "#-3.0");
    test("8.0 mod 5.0", "#3.0");
    test("-8.0 mod 5.0", "#2.0");
    test("8.0 % -5.0", "#3.0");
    test("-8.0 % -5.0", "#-3.0");
    test("8.0 mod -5.0", "#-2.0");
    test("-8.0 mod -5.0", "#-3.0");
  ...
  @Test public void simpleVariableArithmetic() {
    ...
    testError("int x = 1; Decimal y = 0.0; x % y", "divide by zero");
    testError("def x = 1; def y = 0.0; x % y", "divide by zero");
    testError("int x = 1; int y = 0; x mod y", "divide by zero");
    testError("def x = 1; def y = 0; x mod y", "divide by zero");
    test("double x = 1.0D; int y = 0; x mod y", Double.NaN);
    test("def x = 1.0D; def y = 0; x mod y", Double.NaN);
    test("def x = 1.0D; def y = 0L; x mod y", Double.NaN);
    test("double x = -1.0D; int y = 0; x mod y", Double.NaN);
    test("def x = -1.0D; def y = 0; x mod y", Double.NaN);
    testError("long x = 1L; int y = 0; x mod y", "divide by zero");
    testError("def x = 1L; def y = 0; x mod y", "divide by zero");
    testError("Decimal x = 1.0; int y = 0; x mod y", "divide by zero");
    testError("def x = 1.0; def y = 0; x mod y", "divide by zero");
    testError("int x = 1; Decimal y = 0.0; x mod y", "divide by zero");
    testError("def x = 1; def y = 0.0; x mod y", "divide by zero");
    ...
    test("int x = -8; def y = 1; x % y", 0);
    test("def x = -8; int y = 1; x % y", 0);
    test("int x = 8; int y = 5; x mod y", 3);
    test("def x = 8; def y = 5; x mod y", 3);
    test("int x = 8; def y = 5; x mod y", 3);
    test("def x = 8; int y = 5; x mod y", 3);
    test("int x = 8; int y = 1; x mod y", 0);
    test("def x = 8; def y = 1; x mod y", 0);
    test("int x = 8; def y = 1; x mod y", 0);
    test("def x = 8; int y = 1; x mod y", 0);
    test("int x = -8; int y = 5; x mod y", 2);
    test("def x = -8; def y = 5; x mod y", 2);
    test("int x = -8; def y = 5; x mod y", 2);
    test("def x = -8; int y = 5; x mod y", 2);
    test("int x = -8; int y = 1; x mod y", 0);
    test("def x = -8; def y = 1; x mod y", 0);
    test("int x = -8; def y = 1; x mod y", 0);
    test("def x = -8; int y = 1; x mod y", 0);
    ...
    test("long x = -8L; def y = 5L; x % y", -3L);
    test("def x = -8L; long y = 5L; x % y", -3L);
    test("long x = 8L; long y = 5L; x mod y", 3L);
    test("def x = 8L; def y = 5L; x mod y", 3L);
    test("long x = 8L; def y = 5L; x mod y", 3L);
    test("def x = 8L; long y = 5L; x mod y", 3L);
    test("long x = -8L; long y = 5L; x mod y", 2L);
    test("def x = -8L; def y = 5L; x mod y", 2L);
    test("long x = -8L; def y = 5L; x mod y", 2L);
    test("def x = -8L; long y = 5L; x mod y", 2L);
    test("def x = -8L; long y = 5L; 1 + x mod y - 1", 2L);
    ...
    test("int x = -8; def y = 5L; x % y", -3L);
    test("def x = -8; long y = 5L; x % y", -3L);
    test("long x = 8L; int y = 5; x mod y", 3L);
    test("def x = 8L; def y = 5; x mod y", 3L);
    test("long x = 8L; def y = 5; x mod y", 3L);
    test("def x = 8L; int y = 5; x mod y", 3L);
    test("int x = 8; long y = 5L; x mod y", 3L);
    test("def x = 8; def y = 5L; x mod y", 3L);
    test("int x = 8; def y = 5L; x mod y", 3L);
    test("def x = 8; long y = 5L; x mod y", 3L);
    test("long x = -8L; int y = 5; x mod y", 2L);
    test("def x = -8L; def y = 5; x mod y", 2L);
    test("long x = -8L; def y = 5; x mod y", 2L);
    test("def x = -8L; int y = 5; x mod y", 2L);
    test("int x = -8; long y = 5L; x mod y", 2L);
    test("def x = -8; def y = 5L; x mod y", 2L);
    test("int x = -8; def y = 5L; x mod y", 2L);
    test("def x = -8; long y = 5L; x mod y", 2L);
    ...
    test("double x = -8.0D; def y = 5.0D; x % y", -3D);
    test("def x = -8.0D; double y = 5.0D; x % y", -3D);
    test("double x = 8.0D; double y = 5.0D; x mod y", 3D);
    test("def x = 8.0D; def y = 5.0D; x mod y", 3D);
    test("double x = 8.0D; def y = 5.0D; x mod y", 3D);
    test("def x = 8.0D; double y = 5.0D; x mod y", 3D);
    test("double x = -8.0D; double y = 5.0D; x mod y", 2D);
    test("def x = -8.0D; def y = 5.0D; x mod y", 2D);
    test("def x = -8.0D; def y = -5.0D; x mod y", -3D);
    test("def x = 8.0D; def y = -5.0D; x mod y", -2D);
    test("double x = -8.0D; def y = 5.0D; x mod y", 2D);
    test("def x = -8.0D; double y = 5.0D; x mod y", 2D);
    ...
    test("double x = -8.0D; def y = 5L; x % y", -3D);
    test("def x = -8.0D; long y = 5L; x % y", -3D);
    test("double x = 8.0D; long y = 5L; x  mod y", 3D);
    test("def x = 8.0D; def y = 5L; x  mod y", 3D);
    test("double x = 8.0D; def y = 5L; x mod y", 3D);
    test("def x = 8.0D; long y = 5L; x mod y", 3D);
    test("double x = -8.0D; long y = 5L; x  mod y", 2D);
    test("def x = -8.0D; def y = 5L; x  mod y", 2D);
    test("double x = -8.0D; def y = 5L; x mod y", 2D);
    test("def x = -8.0D; long y = 5L; x mod y", 2D);
    ...
    test("Decimal x = -8.0; def y = 5.0; x % y", "#-3.0");
    test("def x = -8.0; Decimal y = 5.0; x % y", "#-3.0");
    test("Decimal x = 8.0; Decimal y = 5.0; x mod y", "#3.0");
    test("def x = 8.0; def y = 5.0; x mod y", "#3.0");
    test("Decimal x = 8.0; def y = 5.0; x mod y", "#3.0");
    test("def x = 8.0; Decimal y = 5.0; x mod y", "#3.0");
    test("Decimal x = -8.0; Decimal y = 5.0; x mod y", "#2.0");
    test("def x = -8.0; def y = 5.0; x mod y", "#2.0");
    test("Decimal x = -8.0; def y = 5.0; x mod y", "#2.0");
    test("def x = -8.0; Decimal y = 5.0; x mod y", "#2.0");
    ...
    test("int x = -8; def y = 5D; x % y", -3D);
    test("def x = -8; double y = 5D; x % y", -3D);
    test("double x = 8D; int y = 5; x mod y", 3D);
    test("def x = 8D; def y = 5; x mod y", 3D);
    test("double x = 8D; def y = 5; x mod y", 3D);
    test("def x = 8D; int y = 5; x mod y", 3D);
    test("int x = 8; double y = 5D; x mod y", 3D);
    test("def x = 8; def y = 5D; x mod y", 3D);
    test("int x = 8; def y = 5D; x mod y", 3D);
    test("def x = 8; double y = 5D; x mod y", 3D);
    test("double x = -8D; int y = 5; x mod y", 2D);
    test("def x = -8D; def y = 5; x mod y", 2D);
    test("double x = -8D; def y = 5; x mod y", 2D);
    test("def x = -8D; int y = 5; x mod y", 2D);
    test("int x = -8; double y = 5D; x mod y", 2D);
    test("def x = -8; def y = 5D; x mod y", 2D);
    test("int x = -8; def y = 5D; x mod y", 2D);
    test("def x = -8; double y = 5D; x mod y", 2D);
    ...
    test("int x = -8; def y = 5.0; x % y", "#-3.0");
    test("def x = -8; Decimal y = 5.0; x % y", "#-3.0");
    test("Decimal x = 8.0; int y = 5; x mod y", "#3.0");
    test("def x = 8.0; def y = 5; x mod y", "#3.0");
    test("Decimal x = 8.0; def y = 5; x mod y", "#3.0");
    test("def x = 8.0; int y = 5; x mod y", "#3.0");
    test("int x = 8; Decimal y = 5.0; x mod y", "#3.0");
    test("def x = 8; def y = 5.0; x mod y", "#3.0");
    test("int x = 8; def y = 5.0; x mod y", "#3.0");
    test("def x = 8; Decimal y = 5.0; x mod y", "#3.0");
    test("Decimal x = -8.0; int y = 5; x mod y", "#2.0");
    test("def x = -8.0; def y = 5; x mod y", "#2.0");
    test("Decimal x = -8.0; def y = 5; x mod y", "#2.0");
    test("def x = -8.0; int y = 5; x mod y", "#2.0");
    test("int x = -8; Decimal y = 5.0; x mod y", "#2.0");
    test("def x = -8; def y = 5.0; x mod y", "#2.0");
    test("int x = -8; def y = 5.0; x mod y", "#2.0");
    test("def x = -8; Decimal y = 5.0; x mod y", "#2.0");
    ...
    test("long x = -8L; def y = 5.0; x % y", "#-3.0");
    test("def x = -8L; Decimal y = 5.0; x % y", "#-3.0");
    test("Decimal x = 8.0; long y = 5L; x mod y", "#3.0");
    test("def x = 8.0; def y = 5L; x mod y", "#3.0");
    test("Decimal x = 8.0; def y = 5L; x mod y", "#3.0");
    test("def x = 8.0; long y = 5L; x mod y", "#3.0");
    test("long x = 8L; Decimal y = 5.0; x mod y", "#3.0");
    test("def x = 8L; def y = 5.0; x mod y", "#3.0");
    test("long x = 8L; def y = 5.0; x mod y", "#3.0");
    test("def x = 8L; Decimal y = 5.0; x mod y", "#3.0");
    test("Decimal x = -8.0; long y = 5L; x mod y", "#2.0");
    test("def x = -8.0; def y = 5L; x mod y", "#2.0");
    test("Decimal x = -8.0; def y = 5L; x mod y", "#2.0");
    test("def x = -8.0; long y = 5L; x mod y", "#2.0");
    test("long x = -8L; Decimal y = 5.0; x mod y", "#2.0");
    test("def x = -8L; def y = 5.0; x mod y", "#2.0");
    test("long x = -8L; def y = 5.0; x mod y", "#2.0");
    test("def x = -8L; Decimal y = 5.0; x mod y", "#2.0");
    ...
    test("double x = -8D; def y = 5.0; x % y", "#-3.0");
    test("def x = -8D; Decimal y = 5.0; x % y", "#-3.0");
    test("Decimal x = 8.0; double y = 5D; x mod y", "#3.0");
    test("def x = 8.0; def y = 5D; x mod y", "#3.0");
    test("Decimal x = 8.0; def y = 5D; x mod y", "#3.0");
    test("def x = 8.0; double y = 5D; x mod y", "#3.0");
    test("double x = 8D; Decimal y = 5.0; x mod y", "#3.0");
    test("def x = 8D; def y = 5.0; x mod y", "#3.0");
    test("double x = 8D; def y = 5.0; x mod y", "#3.0");
    test("def x = 8D; Decimal y = 5.0; x mod y", "#3.0");
    test("Decimal x = -8.0; double y = 5D; x mod y", "#2.0");
    test("def x = -8.0; def y = 5D; x mod y", "#2.0");
    test("Decimal x = -8.0; def y = 5D; x mod y", "#2.0");
    test("def x = -8.0; double y = 5D; x mod y", "#2.0");
    test("double x = -8D; Decimal y = 5.0; x mod y", "#2.0");
    test("def x = -8D; def y = 5.0; x mod y", "#2.0");
    test("double x = -8D; def y = 5.0; x mod y", "#2.0");
    test("def x = -8D; Decimal y = 5.0; x mod y", "#2.0");
  }
  ...
  public void defVariableArithmetic() {
    ...
    test("def x = 5; -8 % x", -3);
    test("def x = -8; def y = 5; x % y", -3);
    test("def x = 8; x mod 5", 3);
    test("def x = 5; 8 mod x", 3);
    test("def x = 8; def y = 5; x mod y", 3);
    test("def x = -8; x mod 5", 2);
    test("def x = 5; -8 mod x", 2);
    test("def x = -8; def y = 5; x mod y", 2);
    ...
    test("def x = 5L; -8L % x", -3L);
    test("def x = -8L; def y = 5L; x % y", -3L);
    test("def x = 8L; x mod 5L", 3L);
    test("def x = 5L; 8L mod x", 3L);
    test("def x = 8L; def y = 5L; x mod y", 3L);
    test("def x = -8L; x mod 5L", 2L);
    test("def x = 5L; -8L mod x", 2L);
    test("def x = -8L; def y = 5L; x mod y", 2L);
    ...
    test("def x = 5L; -8 % x", -3L);
    test("def x = -8; def y = 5L; x % y", -3L);
    test("def x = 8L; x mod 5", 3L);
    test("def x = 5; 8L mod x", 3L);
    test("def x = 8L; def y = 5; x mod y", 3L);
    test("def x = 8; x mod 5L", 3L);
    test("def x = 5L; 8 mod x", 3L);
    test("def x = 8; def y = 5L; x mod y", 3L);
    test("def x = -8L; x mod 5", 2L);
    test("def x = 5; -8L mod x", 2L);
    test("def x = -8L; def y = 5; x mod y", 2L);
    test("def x = -8; x mod 5L", 2L);
    test("def x = 5L; -8 mod x", 2L);
    test("def x = -8; def y = 5L; x mod y", 2L);
    ...
    test("def x =  5.0D; -8.0D % x", -3D);
    test("def x = -8.0D; def y = 5.0D; x % y", -3D);
    test("def x = 8.0D; x mod 5.0D", 3D);
    test("def x =  5.0D; 8.0D mod x", 3D);
    test("def x = 8.0D; def y = 5.0D; x mod y", 3D);
    test("def x = -8.0D; x mod 5.0D", 2D);
    test("def x =  5.0D; -8.0D mod x", 2D);
    test("def x = -8.0D; def y = 5.0D; x mod y", 2D);
    ...
    test("def x =  5L; -8.0D % x", -3D);
    test("def x = -8.0D; def y = 5L; x % y", -3D);
    test("def x = 8.0D; x mod 5L", 3D);
    test("def x =  5L; 8.0D mod x", 3D);
    test("def x = 8.0D; def y = 5L; x mod y", 3D);
    test("def x = -8.0D; x mod 5L", 2D);
    test("def x =  5L; -8.0D mod x", 2D);
    test("def x = -8.0D; def y = 5L; x mod y", 2D);
    ...
    test("def x =  5.0; -8.0 % x", "#-3.0");
    test("def x = -8.0; def y = 5.0; x % y", "#-3.0");
    test("def x = 8.0; x mod 5.0", "#3.0");
    test("def x =  5.0; 8.0 mod x", "#3.0");
    test("def x = 8.0; def y = 5.0; x mod y", "#3.0");
    test("def x = -8.0; x mod 5.0", "#2.0");
    test("def x =  5.0; -8.0 mod x", "#2.0");
    test("def x = -8.0; def y = 5.0; x mod y", "#2.0");
    ...
    test("def x =  5D; -8 % x", -3D);
    test("def x = -8; def y = 5D; x % y", -3D);
    test("def x = 8D; x mod 5", 3D);
    test("def x =  5; 8D mod x", 3D);
    test("def x = 8D; def y = 5; x mod y", 3D);
    test("def x = 8; x mod 5D", 3D);
    test("def x =  5D; 8 mod x", 3D);
    test("def x = 8; def y = 5D; x mod y", 3D);
    test("def x = -8D; x mod 5", 2D);
    test("def x =  5; -8D mod x", 2D);
    test("def x = -8D; def y = 5; x mod y", 2D);
    test("def x = -8; x mod 5D", 2D);
    test("def x =  5D; -8 mod x", 2D);
    test("def x = -8; def y = 5D; x mod y", 2D);
    ...
    test("def x =  5.0; -8 % x", "#-3.0");
    test("def x = -8; def y = 5.0; x % y", "#-3.0");
    test("def x = 8.0; x mod 5", "#3.0");
    test("def x =  5; 8.0 mod x", "#3.0");
    test("def x = 8.0; def y = 5; x mod y", "#3.0");
    test("def x = 8; x mod 5.0", "#3.0");
    test("def x =  5.0; 8 mod x", "#3.0");
    test("def x = 8; def y = 5.0; x mod y", "#3.0");
    test("def x = -8.0; x mod 5", "#2.0");
    test("def x =  5; -8.0 mod x", "#2.0");
    test("def x = -8.0; def y = 5; x mod y", "#2.0");
    test("def x = -8; x mod 5.0", "#2.0");
    test("def x =  5.0; -8 mod x", "#2.0");
    test("def x = -8; def y = 5.0; x mod y", "#2.0");
    ...
    test("def x =  5.0; -8L % x", "#-3.0");
    test("def x = -8L; def y = 5.0; x % y", "#-3.0");
    test("def x = 8.0; x mod 5L", "#3.0");
    test("def x =  5L; 8.0 mod x", "#3.0");
    test("def x = 8.0; def y = 5L; x mod y", "#3.0");
    test("def x = 8L; x mod 5.0", "#3.0");
    test("def x =  5.0; 8L mod x", "#3.0");
    test("def x = 8L; def y = 5.0; x mod y", "#3.0");
    test("def x = -8.0; x mod 5L", "#2.0");
    test("def x =  5L; -8.0 mod x", "#2.0");
    test("def x = -8.0; def y = 5L; x mod y", "#2.0");
    test("def x = -8L; x mod 5.0", "#2.0");
    test("def x =  5.0; -8L mod x", "#2.0");
    test("def x = -8L; def y = 5.0; x mod y", "#2.0");
    ...
    test("def x =  5.0; -8D % x", "#-3.0");
    test("def x = -8D; def y = 5.0; x % y", "#-3.0");
    test("def x = 8.0; x mod 5D", "#3.0");
    test("def x =  5D; 8.0 mod x", "#3.0");
    test("def x = 8.0; def y = 5D; x mod y", "#3.0");
    test("def x = 8D; x mod 5.0", "#3.0");
    test("def x =  5.0; 8D mod x", "#3.0");
    test("def x = 8D; def y = 5.0; x mod y", "#3.0");
    test("def x = -8.0; x mod 5D", "#2.0");
    test("def x =  5D; -8.0 mod x", "#2.0");
    test("def x = -8.0; def y = 5D; x mod y", "#2.0");
    test("def x = -8D; x mod 5.0", "#2.0");
    test("def x =  5.0; -8D mod x", "#2.0");
    test("def x = -8D; def y = 5.0; x mod y", "#2.0");
  ...
  public void constExprArithmeticPrecedence() {
    ...
    test("13 + 12 % 7 - 3", 15);
    test("13 + 12 % ++6 - 3", 15);
    test("13 + 12 mod 7L", 18L);
    test("13 + 12 mod 7 - 3", 15);
    test("13 + 12 mod ++6 - 3", 15);
  }
