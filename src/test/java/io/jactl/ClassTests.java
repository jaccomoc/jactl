...
public class ClassTests extends BaseTest {
  ...
  @Test public void staticFields() {
    ...
    testError("class X { static int i = 0; }; new X().i", "class static fields must be final");
    testError("class X { final int i = 0; }; new X().i", "final fields are only supported for static class fields");
    testError("class X { final final int i = 0; }; new X().i", "'final' cannot appear multiple times");
    testError("class X { final static final int i = 0; }; new X().i", "'final' cannot appear multiple times");
    testError("class X { static static int i = 0; }; new X().i", "'static' cannot appear multiple times");
    testError("class X { static final static int i = 0; }; new X().i", "'static' cannot appear multiple times");
    testError("class X { static final int i = 1 }; X.i = 2; X.i", "cannot modify static final field");
    testError("class X { int i = 1 }; X.i", "static access to non-static field");
    testError("class X { static final int i = sleep(0,1) }; X.i", "must be initialised to simple constant values");
    testError("class X { static final int i = [].size() }; X.i", "must be initialised to simple constant values");
    test("class X { static final int i = 1 }; X.i", 1);
    test("class X { static final int i = 1 }; X.'i'", 1);
    test("class X { static final int i = 1 }; X.\"${'i'}\"", 1);
    testError("class X { static final int i = 1 }; X.i++", "cannot modify static final field");
    testError("class X { static final int i = 1 }; X.i = 1", "cannot modify static final field");
    testError("class X { static final int i = 1 }; ++X.i", "cannot modify static final field");
    testError("class X { static final int i = 1 }; X.'i'++", "cannot modify static final field");
    testError("class X { static final int i = 1 }; X.\"${'i'}\" = 2", "cannot modify class field");
    testError("class X { static final int i = 1 }; X.\"${'i'}\"++", "cannot modify class field");
    testError("class X { static final int i = 1 }; ++X.\"${'i'}\"", "cannot modify class field");
    testError("class X { static final int i = 1 }; X.\"${'i'}\" = 1", "cannot modify class field");
    test("class X { static final int i = 1 }; new X().i", 1);
    testError("class X { static final int i = 1 }; new X().i = 1", "cannot modify static final field");
    testError("class X { static final int i = 1 }; new X().i++", "cannot modify static final field");
    testError("class X { static final int i = 1 }; ++new X().i", "cannot modify static final field");
    test("class X { static final int i = 1 }; new X().\"${'i'}\"", 1);
    testError("class X { static final int i = 1 }; new X().\"${'i'}\" = 1", "cannot modify static final field");
    testError("class X { static final int i = 1 }; new X().\"${'i'}\"++", "cannot modify static final field");
    testError("class X { static final int i = 1 }; ++new X().\"${'i'}\"", "cannot modify static final field");
    testError("class X { static final int i = 1; static def f() { i = i + 1 } }; X.f() + X.i", "cannot modify static final field");
    testError("class X { static final int i = 1; static def f() { ++i } }; X.f() + X.i", "cannot modify a constant value");
    testError("class X { static final int i = 1; static def f() { i++ } }; X.f() + X.i", "cannot modify a constant value");
    testError("class X { static final int i = 1; def f() { i = 2 } }; new X().f()", "cannot modify static final field");
    testError("class X { static final int i = 1; def f() { ++i } }; new X().f()", "cannot modify a constant value");
    test("class X { static final int i = 1; def f() { i } }; new X().f()", 1);
    testError("class X { static final int i = 1; def f() { i++ } }; new X().f()", "cannot modify a constant value");
    testError("class X { static final int i = 1; def f() { this.i = 2 } }; new X().f()", "cannot modify static final field");
    testError("class X { static final int i = 1; def f() { this.\"${'i'}\" = 2 } }; new X().f()", "cannot modify static final field");
    testError("class X { static final int i = 1; def f() { this.\"${'i'}\"++ } }; new X().f()", "cannot modify static final field");
    testError("class X { static final int i = 1; def f() { ++this.i } }; new X().f()", "cannot modify static final field");
    test("class X { static final int i = 1; static final int j = i }; new X().j", 1);
    test("class X { static final int i = 1; static final int j = i + 1 }; new X().j", 2);
    testError("class X { static final int i = 1; static final int j = ++i + 1 }; new X().j + new X().i", "cannot modify a constant value");
    testError("class X { static final int i = 1; static final int j = (i=2) + 1 }; new X().j + new X().i", "cannot modify static final field");
    testError("class X { static final def f = { 1 } }", "initialised to simple constant values");
    testError("class X { static int i = 0; }; new X().i", "class static fields must be final");
    testError("class X { final int i = 0; }; new X().i", "final fields are only supported for static class fields");
    testError("class X { final final int i = 0; }; new X().i", "'final' cannot appear multiple times");
    testError("class X { final static final int i = 0; }; new X().i", "'final' cannot appear multiple times");
    ...
    testError("class X { static final int i = 1; static final int j = (i=2) + 1 }; new X().j + new X().i", "cannot modify static final field");
    testError("class X { static final def f = { 1 } }", "initialised to simple constant values");
    testError("class Y { static int i = 0; }; class X extends Y {};  new X().i", "class static fields must be final");
    testError("class Y { final int i = 0; }; class X extends Y {};  new X().i", "final fields are only supported for static class fields");
    testError("class Y { final final int i = 0; }; class X extends Y {};  new X().i", "'final' cannot appear multiple times");
    testError("class Y { final static final int i = 0; }; class X extends Y {};  new X().i", "'final' cannot appear multiple times");
    testError("class Y { static static int i = 0; }; class X extends Y {};  new X().i", "'static' cannot appear multiple times");
    testError("class Y { static final static int i = 0; }; class X extends Y {};  new X().i", "'static' cannot appear multiple times");
    testError("class Y { static final int i = 1 }; class X extends Y {};  X.i = 2; X.i", "cannot modify static final field");
    testError("class Y { int i = 1 }; class X extends Y {};  X.i", "static access to non-static field");
    testError("class Y { static final int i = sleep(0,1) }; class X extends Y {};  X.i", "must be initialised to simple constant values");
    testError("class Y { static final int i = [].size() }; class X extends Y {};  X.i", "must be initialised to simple constant values");
    test("class Y { static final int i = 1 }; class X extends Y {};  X.i", 1);
    test("class Y { static final int i = 1 }; class X extends Y {};  X.'i'", 1);
    test("class Y { static final int i = 1 }; class X extends Y {};  X.\"${'i'}\"", 1);
    test("class Y { static final String i = '1' }; class X extends Y {};  X.i", "1");
    test("class Y { static final String i = '1' }; class X extends Y {};  X.'i'", "1");
    test("class Y { static final String i = '1' }; class X extends Y {};  X.\"${'i'}\"", "1");
    test("class Y { static final def i = 1 }; class X extends Y {};  X.i", 1);
    test("class Y { static final def i = 1 }; class X extends Y {};  X.'i'", 1);
    test("class Y { static final def i = 1 }; class X extends Y {};  X.\"${'i'}\"", 1);
    test("class Y { static final def i = 1L }; class X extends Y {};  X.i", 1L);
    test("class Y { static final def i = 1L }; class X extends Y {};  X.'i'", 1L);
    test("class Y { static final def i = 1L }; class X extends Y {};  X.\"${'i'}\"", 1L);
    test("class Y { static final long i = 1L }; class X extends Y {};  X.i", 1L);
    test("class Y { static final long i = 1L }; class X extends Y {};  X.'i'", 1L);
    test("class Y { static final long i = 1L }; class X extends Y {};  X.\"${'i'}\"", 1L);
    test("class Y { static final def i = 1D }; class X extends Y {};  X.i", 1D);
    test("class Y { static final def i = 1D }; class X extends Y {};  X.'i'", 1D);
    test("class Y { static final def i = 1D }; class X extends Y {};  X.\"${'i'}\"", 1D);
    test("class Y { static final double i = 1D }; class X extends Y {};  X.i", 1D);
    test("class Y { static final double i = 1D }; class X extends Y {};  X.'i'", 1D);
    test("class Y { static final double i = 1D }; class X extends Y {};  X.\"${'i'}\"", 1D);
    test("class Y { static final def i = 1.0 }; class X extends Y {};  X.i", "#1.0");
    test("class Y { static final def i = 1.0 }; class X extends Y {};  X.'i'", "#1.0");
    test("class Y { static final def i = 1.0 }; class X extends Y {};  X.\"${'i'}\"", "#1.0");
    test("class Y { static final Decimal i = 1.0 }; class X extends Y {};  X.i", "#1.0");
    test("class Y { static final Decimal i = 1.0 }; class X extends Y {};  X.'i'", "#1.0");
    test("class Y { static final Decimal i = 1.0 }; class X extends Y {};  X.\"${'i'}\"", "#1.0");
    testError("class Y { static final int i = 1 }; class X extends Y {};  X.i++", "cannot modify static final field");
    testError("class Y { static final int i = 1 }; class X extends Y {};  X.i = 1", "cannot modify static final field");
    testError("class Y { static final int i = 1 }; class X extends Y {};  ++X.i", "cannot modify static final field");
    testError("class Y { static final int i = 1 }; class X extends Y {};  X.'i'++", "cannot modify static final field");
    testError("class Y { static final int i = 1 }; class X extends Y {};  X.\"${'i'}\" = 2", "cannot modify class field");
    testError("class Y { static final int i = 1 }; class X extends Y {};  X.\"${'i'}\"++", "cannot modify class field");
    testError("class Y { static final int i = 1 }; class X extends Y {};  ++X.\"${'i'}\"", "cannot modify class field");
    testError("class Y { static final int i = 1 }; class X extends Y {};  X.\"${'i'}\" = 1", "cannot modify class field");
    test("class Y { static final int i = 1 }; class X extends Y {};  new X().i", 1);
    testError("class Y { static final int i = 1 }; class X extends Y {};  new X().i = 1", "cannot modify static final field");
    testError("class Y { static final int i = 1 }; class X extends Y {};  new X().i++", "cannot modify static final field");
    testError("class Y { static final int i = 1 }; class X extends Y {};  ++new X().i", "cannot modify static final field");
    test("class Y { static final int i = 1 }; class X extends Y {};  new X().\"${'i'}\"", 1);
    testError("class Y { static final int i = 1 }; class X extends Y {};  new X().\"${'i'}\" = 1", "cannot modify static final field");
    testError("class Y { static final int i = 1 }; class X extends Y {};  new X().\"${'i'}\"++", "cannot modify static final field");
    testError("class Y { static final int i = 1 }; class X extends Y {};  ++new X().\"${'i'}\"", "cannot modify static final field");
    testError("class Y { static final int i = 1; static def f() { i = i + 1 } }; class X extends Y {};  X.f() + X.i", "cannot modify static final field");
    testError("class Y { static final int i = 1; static def f() { ++i } }; class X extends Y {};  X.f() + X.i", "cannot modify a constant value");
    testError("class Y { static final int i = 1; static def f() { i++ } }; class X extends Y {};  X.f() + X.i", "cannot modify a constant value");
    testError("class Y { static final int i = 1; def f() { i = 2 } }; class X extends Y {};  new X().f()", "cannot modify static final field");
    testError("class Y { static final int i = 1; def f() { ++i } }; class X extends Y {};  new X().f()", "cannot modify a constant value");
    test("class Y { static final int i = 1; def f() { i } }; class X extends Y {};  new X().f()", 1);
    testError("class Y { static final int i = 1; def f() { i++ } }; class X extends Y {};  new X().f()", "cannot modify a constant value");
    testError("class Y { static final int i = 1; def f() { this.i = 2 } }; class X extends Y {};  new X().f()", "cannot modify static final field");
    testError("class Y { static final int i = 1; def f() { this.\"${'i'}\" = 2 } }; class X extends Y {};  new X().f()", "cannot modify static final field");
    testError("class Y { static final int i = 1; def f() { this.\"${'i'}\"++ } }; class X extends Y {};  new X().f()", "cannot modify static final field");
    testError("class Y { static final int i = 1; def f() { ++this.i } }; class X extends Y {};  new X().f()", "cannot modify static final field");
    test("class Y { static final int i = 1; static final int j = i }; class X extends Y {};  new X().j", 1);
    test("class Y { static final int i = 1; static final int j = i + 1 }; class X extends Y {};  new X().j", 2);
    testError("class Y { static final int i = 1; static final int j = ++i + 1 }; class X extends Y {};  new X().j + new X().i", "cannot modify a constant value");
    testError("class Y { static final int i = 1; static final int j = (i=2) + 1 }; class X extends Y {};  new X().j + new X().i", "cannot modify static final field");
    testError("class Y { static final def f = { 1 } }", "initialised to simple constant values");
    testError("class Y { static final int i = 1 }; class X extends Y { int i = 2 }; new X().i", "field 'i' clashes with another field");
    testError("class Y { int i = 1 }; class X extends Y { static final int i = 2 }; new X().i", "field 'i' clashes with another field");
    testError("class Y { int i() {1} }; class X extends Y { static final int i = 2 }; new X().i", "field 'i' clashes with another field");
    testError("class Y { static int i() {1} }; class X extends Y { static final int i = 2 }; new X().i", "field 'i' clashes with another field");
    testError("class Y { static final int i = 1 }; class X extends Y { int i() {2} }; new X().i", "'i' clashes with another field");
    testError("class Y { static final int i = 1 }; class X extends Y { static int i() {2} }; new X().i", "'i' clashes with another field");
    testError("class X { static final List x = [1,2,3] }; X.x", "simple constant value");
    testError("class X { static final def x = [1,2,3] }; X.x", "simple constant value");
    testError("class X { static final int[] x = [1,2,3] }; X.x", "simple constant value");
    testError("class X { static final Map x = [:] }; X.x", "simple constant value");
    testError("class X { static final def x = [:] }; X.x", "simple constant value");
