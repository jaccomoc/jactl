...
public class ClassTests extends BaseTest {
  ...
  @Test public void mutatingPrimitiveFieldValues() {
    test("class X { byte i = (byte)1 }; new X().i = 3", 3);
    test("class X { byte i = (byte)1 }; new X().i ?= 3", 3);
    test("class X { byte i = (byte)1 }; new X().\"${'i'}\" = 3", 3);
    test("class X { byte i = (byte)1 }; X x = new X(); x.\"${'i'}\" = 3", 3);
    test("class X { byte i = (byte)1 }; def x = new X(); x.\"${'i'}\" = 3", 3);
    test("class X { byte i = (byte)1 }; new X().i += 3", 4);
    test("class X { byte i = (byte)1 }; new X().\"${'i'}\" += 3", 4);
    test("class X { byte i = (byte)1 }; X x = new X(); x.\"${'i'}\" += 3", 4);
    test("class X { byte i = (byte)1 }; def x = new X(); x.\"${'i'}\" += 3", 4);
    test("class X { byte i = (byte)1 }; new X().i++", (byte)1);
    test("class X { byte i = (byte)1 }; X x = new X(); x.i++", (byte)1);
    ...
    test("class X { byte i = (byte)1 }; def x = new X(); x.\"${'i'}\"++", (byte)1);
    test("class X { byte i = (byte)1 }; def x = new X(); ++x.\"${'i'}\"", (byte)2);
    test("class X { byte i = (byte)1 }; new X().i = 3L", 3L);
    test("class X { byte i = (byte)1 }; new X().\"${'i'}\" = 3L", 3L);
    test("class X { byte i = (byte)1 }; new X().i += 3L", 4L);
    test("class X { byte i = (byte)1 }; new X().\"${'i'}\" += 3L", 4L);
    test("class X { byte i = (byte)1 }; new X().i = 3.0D", 3D);
    test("class X { byte i = (byte)1 }; new X().\"${'i'}\" = 3.0D", 3D);
    test("class X { byte i = (byte)1 }; new X().i += 3.0", "#4.0");
    test("class X { byte i = (byte)1 }; new X().\"${'i'}\" += 3.0", "#4.0");

    test("class X { var i = (byte)1 }; new X().i = 3", 3);
    test("class X { var i = (byte)1 }; new X().\"${'i'}\" = 3", 3);
    test("class X { var i = (byte)1 }; X x = new X(); x.\"${'i'}\" = 3", 3);
    test("class X { var i = (byte)1 }; def x = new X(); x.\"${'i'}\" = 3", 3);
    test("class X { var i = (byte)1 }; new X().i += 3", 4);
    test("class X { var i = (byte)1 }; new X().\"${'i'}\" += 3", 4);
    test("class X { var i = (byte)1 }; X x = new X(); x.\"${'i'}\" += 3", 4);
    test("class X { var i = (byte)1 }; def x = new X(); x.\"${'i'}\" += 3", 4);
    ...
    test("class X { var i = (byte)1 }; new X().i = 3L", 3L);
    test("class X { var i = (byte)1 }; new X().\"${'i'}\" = 3L", 3L);
    test("class X { var i = (byte)1 }; new X().i += 3L", 4L);
    test("class X { var i = (byte)1 }; new X().\"${'i'}\" += 3L", 4L);
    test("class X { var i = (byte)1 }; new X().i = 3.0D", 3D);
    test("class X { var i = (byte)1 }; new X().\"${'i'}\" = 3.0D", 3D);
    test("class X { var i = (byte)1 }; new X().i += 3.0", "#4.0");
    test("class X { var i = (byte)1 }; new X().\"${'i'}\" += 3.0", "#4.0");
    ...
    test("class X { int i = 1 }; new X().i = 3L", 3L);
    test("class X { int i = 1 }; new X().\"${'i'}\" = 3L", 3L);
    test("class X { int i = 1 }; new X().i += 3L", 4L);
    test("class X { int i = 1 }; new X().\"${'i'}\" += 3L", 4L);
    test("class X { int i = 1 }; new X().i = 3.0D", 3D);
    test("class X { int i = 1 }; new X().\"${'i'}\" = 3.0D", 3D);
    test("class X { int i = 1 }; new X().i += 3.0", "#4.0");
    test("class X { int i = 1 }; new X().\"${'i'}\" += 3.0", "#4.0");
    ...
    test("class X { var i = 1 }; new X().i = 3L", 3L);
    test("class X { var i = 1 }; new X().\"${'i'}\" = 3L", 3L);
    test("class X { var i = 1 }; new X().i += 3L", 4L);
    test("class X { var i = 1 }; new X().\"${'i'}\" += 3L", 4L);
    test("class X { var i = 1 }; new X().i = 3.0D", 3D);
    test("class X { var i = 1 }; new X().\"${'i'}\" = 3.0D", 3D);
    test("class X { var i = 1 }; new X().i += 3.0", "#4.0");
    test("class X { var i = 1 }; new X().\"${'i'}\" += 3.0", "#4.0");

    test("class X { long i = 1 }; new X().i = 3", 3);
    test("class X { long i = 1 }; new X().\"${'i'}\" = 3", 3);
    test("class X { long i = 1 }; X x = new X(); x.\"${'i'}\" = 3", 3);
    test("class X { long i = 1 }; def x = new X(); x.\"${'i'}\" = 3", 3);
    ...
    test("class X { long i = 1 }; new X().i = 3D", 3D);
    test("class X { long i = 1 }; new X().\"${'i'}\" = 3D", 3D);
    test("class X { long i = 1 }; new X().i += 3D", 4.0D);
    test("class X { long i = 1 }; new X().\"${'i'}\" += 3D", 4.0D);
    test("class X { long i = 1 }; new X().i = 3.0", "#3.0");
    test("class X { long i = 1 }; new X().\"${'i'}\" = 3.0", "#3.0");
    test("class X { long i = 1 }; new X().i += 3.0", "#4.0");
    test("class X { long i = 1 }; new X().\"${'i'}\" += 3.0", "#4.0");

    test("class X { double i = 1 }; new X().i = 3", 3);
    test("class X { double i = 1 }; new X().\"${'i'}\" = 3", 3);
    test("class X { double i = 1 }; X x = new X(); x.\"${'i'}\" = 3", 3);
    test("class X { double i = 1 }; def x = new X(); x.\"${'i'}\" = 3", 3);
    ...
    test("class X { double i = 1 }; new X().i = 3L", 3L);
    test("class X { double i = 1 }; new X().\"${'i'}\" = 3L", 3L);
    test("class X { double i = 1 }; new X().i += 3L", 4D);
    test("class X { double i = 1 }; new X().\"${'i'}\" += 3L", 4D);
    test("class X { double i = 1 }; new X().i = 3.0", "#3.0");
    test("class X { double i = 1 }; new X().\"${'i'}\" = 3.0", "#3.0");
    test("class X { double i = 1 }; new X().i += 3.0", "#4.0");
    test("class X { double i = 1 }; new X().\"${'i'}\" += 3.0", "#4.0");
    ...
    test("class X { Decimal i = 1 }; new X().i = 3L", 3L);
    test("class X { Decimal i = 1 }; new X().\"${'i'}\" = 3L", 3L);
    test("class X { Decimal i = 1 }; new X().i += 3L", "#4");
    test("class X { Decimal i = 1 }; new X().\"${'i'}\" += 3L", "#4");
    test("class X { Decimal i = 1 }; new X().i = 3.0D", 3D);
    test("class X { Decimal i = 1 }; new X().\"${'i'}\" = 3.0D", 3.0D);
  ...
  @Test public void assignmentsAndEquality() {
    ...
    test("class X { byte i }; X x = [i:2]; x.i = 3", 3);
  ...
  @Test public void arrays() {
    ...
    test("class X{ int i = 3; byte[] a = new byte[10] }; new X().a = 'abc'", "abc");
  ...
  @Test public void classAccessToGlobals() {
    ...
    test(Utils.listOf("class X { int i = GVAR; int f() { sleep(0,i) + GMAP.y } }"), "new X().f()", 124);
