...
//    test("def val =['a a':1,b:[z:4],c:3]; def x = 'b'; switch(val) { [\"${'abc'[0]} a\":1,\"$x\":x,*] -> x; default -> 2 }", Utils.mapOf("z",4));
    ...
    test("Map[][] x = [[[i:3]],[[i:4]]]; switch (x) { [[_],[[i:3]]] -> 3; [[[i:3]],[a]] -> a; _ -> null } == [i:4]", true);
    test("Map[][] x = [[[i:3]],[[i:4]]]; switch (x) { [[_],[[i:3]]] -> 3; [[[i:3L]],[a]] -> a; _ -> null } == [i:4]", true);
    test("Map[][] x = [[[i:3]],[[i:4]]]; switch (x) { [[_],[[i:3]]] -> 3; [[[i:3D]],[a]] -> a; _ -> null } == [i:4]", true);
    test("Map[][] x = [[[i:3]],[[i:4]]]; switch (x) { [[_],[[i:3]]] -> 3; [[[i:3.0]],[a]] -> a; _ -> null } == [i:4]", true);
    ...
    test("def x = [[[i:3]],[[i:4]]] as Map[][]; switch (x) { [[_],[[i:3]]] -> 3; [[[i:3L]],[a]] -> a; _ -> null } == [i:4]", true);
    test("def x = [[[i:3]],[[i:4]]] as Map[][]; switch (x) { [[_],[[i:3]]] -> 3; [[[i:3D]],[a]] -> a; _ -> null } == [i:4]", true);
    test("def x = [[[i:3]],[[i:4]]] as Map[][]; switch (x) { [[_],[[i:3]]] -> 3; [[[i:3.0]],[a]] -> a; _ -> null } == [i:4]", true);
    ...
    test("Map[][] x = [[[i:3,j:7]],[[i:4,j:9]]]; switch (x) { [[_],[[i:3,*]]] -> 3; [[[i:3,*]],[a]] -> a; _ -> null } == [i:4,j:9]", true);
    test("Map[][] x = [[[i:3,j:7]],[[i:4,j:9]]]; switch (x) { [[_],[[i:3,*]]] -> 3; [[[i:3L,*]],[a]] -> a; _ -> null } == [i:4,j:9]", true);
    test("Map[][] x = [[[i:3,j:7]],[[i:4,j:9]]]; switch (x) { [[_],[[i:3,*]]] -> 3; [[[i:3D,*]],[a]] -> a; _ -> null } == [i:4,j:9]", true);
    test("Map[][] x = [[[i:3,j:7]],[[i:4,j:9]]]; switch (x) { [[_],[[i:3,*]]] -> 3; [[[i:3.0,*]],[a]] -> a; _ -> null } == [i:4,j:9]", true);
    ...
    test("def x = [[[i:3,j:7]],[[i:4,j:9]]] as Map[][]; switch (x) { [[_],[[i:3,*]]] -> 3; [[[i:3L,*]],[a]] -> a; _ -> null } == [i:4,j:9]", true);
    test("def x = [[[i:3,j:7]],[[i:4,j:9]]] as Map[][]; switch (x) { [[_],[[i:3,*]]] -> 3; [[[i:3D,*]],[a]] -> a; _ -> null } == [i:4,j:9]", true);
    test("def x = [[[i:3,j:7]],[[i:4,j:9]]] as Map[][]; switch (x) { [[_],[[i:3,*]]] -> 3; [[[i:3.0,*]],[a]] -> a; _ -> null } == [i:4,j:9]", true);
    ...
    test("Map[][] x = [[[i:3,j:7]],[[i:4,j:9]]]; switch (x) { [[_],[[i:3,j:7]]] -> 3; [[[i:3,j:7]],[a]] -> a; _ -> null } == [i:4,j:9]", true);
    test("Map[][] x = [[[i:3,j:7]],[[i:4,j:9]]]; switch (x) { [[_],[[i:3,j:7]]] -> 3; [[[i:3L,j:7]],[a]] -> a; _ -> null } == [i:4,j:9]", true);
    test("Map[][] x = [[[i:3,j:7]],[[i:4,j:9]]]; switch (x) { [[_],[[i:3,j:7]]] -> 3; [[[i:3D,j:7]],[a]] -> a; _ -> null } == [i:4,j:9]", true);
    test("Map[][] x = [[[i:3,j:7]],[[i:4,j:9]]]; switch (x) { [[_],[[i:3,j:7]]] -> 3; [[[i:3.0,j:7]],[a]] -> a; _ -> null } == [i:4,j:9]", true);
    ...
    test("def x = [[[i:3,j:7]],[[i:4,j:9]]] as Map[][]; switch (x) { [[_],[[i:3,j:7]]] -> 3; [[[i:3L,j:7]],[a]] -> a; _ -> null } == [i:4,j:9]", true);
    test("def x = [[[i:3,j:7]],[[i:4,j:9]]] as Map[][]; switch (x) { [[_],[[i:3,j:7]]] -> 3; [[[i:3D,j:7]],[a]] -> a; _ -> null } == [i:4,j:9]", true);
    test("def x = [[[i:3,j:7]],[[i:4,j:9]]] as Map[][]; switch (x) { [[_],[[i:3,j:7]]] -> 3; [[[i:3.0,j:7]],[a]] -> a; _ -> null } == [i:4,j:9]", true);
    ...
    test("def x = [[[i:3,j:7]],[[i:4,j:9]]]; switch (x) { [[_],[[i:3,j:7]]] -> 3; [[[i:3L,j:7]],[a]] -> a; _ -> null } == [i:4,j:9]", true);
    test("def x = [[[i:3,j:7]],[[i:4,j:9]]]; switch (x) { [[_],[[i:3,j:7]]] -> 3; [[[i:3D,j:7]],[a]] -> a; _ -> null } == [i:4,j:9]", true);
    test("def x = [[[i:3,j:7]],[[i:4,j:9]]]; switch (x) { [[_],[[i:3,j:7]]] -> 3; [[[i:3.0,j:7]],[a]] -> a; _ -> null } == [i:4,j:9]", true);
  ...
  @Test public void switchOnList() {
    ...
    test("List[][] x = [[[3]],[[4]]]; switch (x) { [[_],[[3]]] -> 3; [[[3]],[a]] -> a; _ -> null } == [4]", true);
    test("List[][] x = [[[3]],[[4]]]; switch (x) { [[_],[[3]]] -> 3; [[[3L]],[a]] -> a; _ -> null } == [4]", true);
    test("List[][] x = [[[3]],[[4]]]; switch (x) { [[_],[[3]]] -> 3; [[[3D]],[a]] -> a; _ -> null } == [4]", true);
    test("List[][] x = [[[3]],[[4]]]; switch (x) { [[_],[[3]]] -> 3; [[[3.0]],[a]] -> a; _ -> null } == [4]", true);
    ...
    test("def x = [[[3]],[[4]]] as List[][]; switch (x) { [[_],[[3]]] -> 3; [[[3L]],[a]] -> a; _ -> null } == [4]", true);
    test("def x = [[[3]],[[4]]] as List[][]; switch (x) { [[_],[[3]]] -> 3; [[[3D]],[a]] -> a; _ -> null } == [4]", true);
    test("def x = [[[3]],[[4]]] as List[][]; switch (x) { [[_],[[3]]] -> 3; [[[3.0]],[a]] -> a; _ -> null } == [4]", true);
    ...
    test("List[][] x = [[[3,7]],[[4,9]]]; switch (x) { [[_],[[3,*]]] -> 3; [[[3,*]],[a]] -> a; _ -> null } == [4,9]", true);
    test("List[][] x = [[[3,7]],[[4,9]]]; switch (x) { [[_],[[3,*]]] -> 3; [[[3L,*]],[a]] -> a; _ -> null } == [4,9]", true);
    test("List[][] x = [[[3,7]],[[4,9]]]; switch (x) { [[_],[[3,*]]] -> 3; [[[3D,*]],[a]] -> a; _ -> null } == [4,9]", true);
    test("List[][] x = [[[3,7]],[[4,9]]]; switch (x) { [[_],[[3,*]]] -> 3; [[[3.0,*]],[a]] -> a; _ -> null } == [4,9]", true);
    ...
    test("def x = [[[3,7]],[[4,9]]] as List[][]; switch (x) { [[_],[[3,*]]] -> 3; [[[3L,*]],[a]] -> a; _ -> null } == [4,9]", true);
    test("def x = [[[3,7]],[[4,9]]] as List[][]; switch (x) { [[_],[[3,*]]] -> 3; [[[3D,*]],[a]] -> a; _ -> null } == [4,9]", true);
    test("def x = [[[3,7]],[[4,9]]] as List[][]; switch (x) { [[_],[[3,*]]] -> 3; [[[3.0,*]],[a]] -> a; _ -> null } == [4,9]", true);
    ...
    test("List[][] x = [[[3,7]],[[4,9]]]; switch (x) { [[_],[[3,7]]] -> 3; [[[3,7]],[a]] -> a; _ -> null } == [4,9]", true);
    test("List[][] x = [[[3,7]],[[4,9]]]; switch (x) { [[_],[[3,7]]] -> 3; [[[3L,7]],[a]] -> a; _ -> null } == [4,9]", true);
    test("List[][] x = [[[3,7]],[[4,9]]]; switch (x) { [[_],[[3,7]]] -> 3; [[[3D,7]],[a]] -> a; _ -> null } == [4,9]", true);
    test("List[][] x = [[[3,7]],[[4,9]]]; switch (x) { [[_],[[3,7]]] -> 3; [[[3.0,7]],[a]] -> a; _ -> null } == [4,9]", true);
    ...
    test("def x = [[[3,7]],[[4,9]]] as List[][]; switch (x) { [[_],[[3,7]]] -> 3; [[[3L,7]],[a]] -> a; _ -> null } == [4,9]", true);
    test("def x = [[[3,7]],[[4,9]]] as List[][]; switch (x) { [[_],[[3,7]]] -> 3; [[[3D,7]],[a]] -> a; _ -> null } == [4,9]", true);
    test("def x = [[[3,7]],[[4,9]]] as List[][]; switch (x) { [[_],[[3,7]]] -> 3; [[[3.0,7]],[a]] -> a; _ -> null } == [4,9]", true);
    ...
    test("def x = [[[3,7]],[[4,9]]]; switch (x) { [[_],[[3,7]]] -> 3; [[[3L,7]],[a]] -> a; _ -> null } == [4,9]", true);
    test("def x = [[[3,7]],[[4,9]]]; switch (x) { [[_],[[3,7]]] -> 3; [[[3D,7]],[a]] -> a; _ -> null } == [4,9]", true);
    test("def x = [[[3,7]],[[4,9]]]; switch (x) { [[_],[[3,7]]] -> 3; [[[3.0,7]],[a]] -> a; _ -> null } == [4,9]", true);
  ...
  @Test public void switchWithClassConstructor() {
    ...
    test("class X{int i}; X[][] x = [[new X(3)],[new X(4)]]; switch (x) { [[_],[X(3)]] -> 3; [[X(3.0)],[a]] -> a; _ -> null } == new X(4)", true);
    ...
    test("class X{int i}; def x = [[new X(3)],[new X(4)]] as X[][]; switch (x) { [[_],[X(3)]] -> 3; [[X(3.0)],[a]] -> a; _ -> null } == new X(4)", true);
    ...
    test("class X{int i;long j}; X[][] x = [[new X(3,7)],[new X(4,9)]]; switch (x) { [[_],[X(i:3)]] -> 3; [[X(i:3.0)],[a]] -> a; _ -> null } == new X(4,9)", true);
    ...
    test("class X{int i;long j}; def x = [[new X(3,7)],[new X(4,9)]] as X[][]; switch (x) { [[_],[X(i:3)]] -> 3; [[X(i:3.0)],[a]] -> a; _ -> null } == new X(4,9)", true);
    ...
    test("class X{int i;long j}; X[][] x = [[new X(3,7)],[new X(4,9)]]; switch (x) { [[_],[X(i:3,j:7)]] -> 3; [[X(i:3.0,j:7)],[a]] -> a; _ -> null } == new X(4,9)", true);
    ...
    test("class X{int i;long j}; def x = [[new X(3,7)],[new X(4,9)]] as X[][]; switch (x) { [[_],[X(i:3,j:7)]] -> 3; [[X(i:3.0,j:7)],[a]] -> a; _ -> null } == new X(4,9)", true);
  ...
  @Test public void switchTypeByte() {
    ...
    test("byte x = 3; switch (x) { 3L -> true; default -> false }", true);
    test("byte x = 3; switch (x) { 5 -> null; 3 -> true; default -> false }", true);
    test("byte x = 3; switch (x) { 5L -> null; 3L -> true; default -> false }", true);
    test("byte x = 4; switch (x) { 5 -> null; 3L -> true; default -> false }", false);
    ...
    test("List x = [(byte)3]; switch (x) { [3L] -> true; default -> false }", true);
    test("List x = [(byte)3]; switch (x) { [5] -> null; [3] -> true; default -> false }", true);
    test("List x = [(byte)3]; switch (x) { [5L] -> null; [3L] -> true; default -> false }", true);
  ...
  @Test public void switchTypeInt() {
    ...
    test("int x = 3; switch (x) { 3L -> true; default -> false }", true);
    test("int x = 3; switch (x) { 5 -> null; 3 -> true; default -> false }", true);
    test("int x = 3; switch (x) { 5L -> null; 3L -> true; default -> false }", true);
    test("int x = 4; switch (x) { 5 -> null; 3L -> true; default -> false }", false);
    ...
    test("List x = [3]; switch (x) { [3L] -> true; default -> false }", true);
    test("List x = [3]; switch (x) { [5] -> null; [3] -> true; default -> false }", true);
    test("List x = [3]; switch (x) { [5L] -> null; [3L] -> true; default -> false }", true);
    ...
    test("int[][] x = [[3],[4]]; switch (x) { [[_],[3]] -> 3; [[3],[a]] -> a; _ -> null }", (int)4);
    test("int[][] x = [[3],[4]]; switch (x) { [[_],[3]] -> 3; [[3L],[a]] -> a; _ -> null }", (int)4);
    test("int[][] x = [[3],[4]]; switch (x) { [[_],[3]] -> 3; [[3D],[a]] -> a; _ -> null }", (int)4);
    test("int[][] x = [[3],[4]]; switch (x) { [[_],[3]] -> 3; [[3.0],[a]] -> a; _ -> null }", (int)4);
    ...
    test("def x = [[3],[4]] as int[][]; switch (x) { [[_],[3]] -> 3; [[3L],[a]] -> a; _ -> null }", (int)4);
    test("def x = [[3],[4]] as int[][]; switch (x) { [[_],[3]] -> 3; [[3D],[a]] -> a; _ -> null }", (int)4);
    test("def x = [[3],[4]] as int[][]; switch (x) { [[_],[3]] -> 3; [[3.0],[a]] -> a; _ -> null }", (int)4);
  ...
  @Test public void switchTypeLong() {
    test("switch (3) { 3 -> true; default -> false }", true);
    test("long x = 3; switch (x) { 3 -> true; default -> false }", true);
    test("long x = 3; switch (x) { 3L -> true; default -> false }", true);
    test("long x = 3; switch (x) { 5 -> null; 3 -> true; default -> false }", true);
    test("long x = 3; switch (x) { 5L -> null; 3L -> true; default -> false }", true);
    test("long x = 4; switch (x) { 5 -> null; 3L -> true; default -> false }", false);
    ...
    test("def x = 3L; switch (x) { 3 -> true; default -> false }", true);
    ...
    test("List x = [3L]; switch (x) { [3] -> true; default -> false }", true);
    ...
    test("def x = [3L]; switch (x) { [5] -> null; [3] -> true; default -> false }", true);
    test("def x = [4L]; switch (x) { [5] -> null; [3L] -> true; default -> false }", false);
    test("def x = [4L]; switch (x) { [long] -> true; [int] -> null; default -> false }", true);
    test("def x = [4L]; switch (x) { [String] -> true; default -> false }", false);
    test("class X{}; def x = [4L]; switch (x) { [X] -> true; default -> false }", false);
    test("package a.b; class X{}; def x = [4L]; switch (x) { [a.b.X] -> true; default -> false }", false);
    test("long[] x = [3,4]; switch (x) { [3,3] -> 4; [3,4] -> 3; _ -> null }", 3);
    test("long[] x = [3,4]; switch (x) { [_,3] -> 4; [3,_] -> 3; _ -> null }", 3);
    test("long[] x = [3,4]; switch (x) { [_,3] -> 3; [3,a] -> a; _ -> null }", (long)4);
    test("def x = [3,4] as long[]; switch (x) { [3,3] -> 4; [3,4] -> 3; _ -> null }", 3);
    test("def x = [3,4] as long[]; switch (x) { [3,3] -> 4; [_,4] -> 3; _ -> null }", 3);
    test("def x = [3,4] as long[]; switch (x) { [3,3] -> 4; [a,4] -> a; _ -> null }", (long)3);
    testError("long[][] x = [[3],[4]]; switch (x) { [_,3] -> 3; [3,a] -> a; _ -> null }", "can never match");
    test("long[][] x = [[3],[4]]; switch (x) { [[_],[3]] -> 3; [[3],[a]] -> a; _ -> null }", (long)4);
    test("long[][] x = [[3],[4]]; switch (x) { [[_],[3]] -> 3; [[3],_] -> 4; _ -> null }", 4);
    test("long[][] x = [[3],[4]]; switch (x) { [[_],[3]] -> 3; [_,[a]] -> a; _ -> null }", (long)4);
    test("long[][] x = [[3],[4]]; switch (x) { [[_],[3]] -> 3; [_,[long a]] -> a; _ -> null }", (long)4);
    test("def x = [[3],[4]] as long[][]; switch (x) { [[_],[3]] -> 3; [[3],[a]] -> a; _ -> null }", (long)4);
    test("def x = [[3],[4]] as long[][]; switch (x) { [[_],[3]] -> 3; [[3],_] -> 4; _ -> null }", 4);
    test("def x = [[3],[4]] as long[][]; switch (x) { [[_],[3]] -> 3; [_,[a]] -> a; _ -> null }", (long)4);
    test("def x = [[3],[4]] as long[][]; switch (x) { [[_],[3]] -> 3; [_,[long a]] -> a; _ -> null }", (long)4);
    ...
    test("long[][] x = [[3],[4]]; switch (x) { [[_],[3L]] -> 3L; [[3L],[a]] -> a; _ -> null }", (long)4);
    test("long[][] x = [[3],[4]]; switch (x) { [[_],[3L]] -> 3L; [[3],[a]] -> a; _ -> null }", (long)4);
    test("long[][] x = [[3],[4]]; switch (x) { [[_],[3L]] -> 3L; [[3D],[a]] -> a; _ -> null }", (long)4);
    test("long[][] x = [[3],[4]]; switch (x) { [[_],[3L]] -> 3L; [[3.0],[a]] -> a; _ -> null }", (long)4);
    ...
    test("def x = [[3],[4]] as long[][]; switch (x) { [[_],[3L]] -> 3L; [[3],[a]] -> a; _ -> null }", (long)4);
    test("def x = [[3],[4]] as long[][]; switch (x) { [[_],[3L]] -> 3L; [[3D],[a]] -> a; _ -> null }", (long)4);
    test("def x = [[3],[4]] as long[][]; switch (x) { [[_],[3L]] -> 3L; [[3.0],[a]] -> a; _ -> null }", (long)4);
  ...
  @Test public void switchTypeDouble() {
    test("switch (3.0D) { 3 -> true; default -> false }", true);
    test("double x = 3; switch (x) { 3.0D -> true; default -> false }", true);
    test("double x = 3; switch (x) { 3L -> true; default -> false }", true);
    test("double x = 3.0D; switch (x) { 5 -> null; 3 -> true; default -> false }", true);
    test("double x = 3.0D; switch (x) { 5L -> null; 3.0D -> true; default -> false }", true);
    test("double x = 4; switch (x) { 5 -> null; 3.0D -> true; default -> false }", false);
    ...
    test("def x = 3.0D; switch (x) { 3 -> true; default -> false }", true);
    test("def x = 3.0D; switch (x) { 5 -> null; 3.0D -> true; default -> false }", true);
    test("def x = 4.0D; switch (x) { 5 -> null; 3 -> true; default -> false }", false);
    ...
    test("List x = [3.0D]; switch (x) { [3] -> true; default -> false }", true);
    ...
    test("def x = [3.0D]; switch (x) { [5] -> null; [3] -> true; default -> false }", true);
    test("def x = [4.0D]; switch (x) { [5] -> null; [3.0D] -> true; default -> false }", false);
    test("def x = [4.0D]; switch (x) { [double] -> true; [int] -> null; default -> false }", true);
    test("def x = [4.0D]; switch (x) { [String] -> true; default -> false }", false);
    test("class X{}; def x = [4.0D]; switch (x) { [X] -> true; default -> false }", false);
    test("package a.b; class X{}; def x = [4.0D]; switch (x) { [a.b.X] -> true; default -> false }", false);
    test("double[] x = [3,4]; switch (x) { [3,3] -> 4; [3,4] -> 3; _ -> null }", 3);
    test("double[] x = [3,4]; switch (x) { [_,3] -> 4; [3,_] -> 3; _ -> null }", 3);
    test("double[] x = [3,4]; switch (x) { [_,3] -> 3; [3,a] -> a; _ -> null }", (double)4);
    test("def x = [3,4] as double[]; switch (x) { [3,3] -> 4; [3,4] -> 3; _ -> null }", 3);
    test("def x = [3,4] as double[]; switch (x) { [3,3] -> 4; [_,4] -> 3; _ -> null }", 3);
    test("def x = [3,4] as double[]; switch (x) { [3,3] -> 4; [a,4] -> a; _ -> null }", (double)3);
    testError("double[][] x = [[3],[4]]; switch (x) { [_,3] -> 3; [3,a] -> a; _ -> null }", "can never match");
    test("double[][] x = [[3],[4]]; switch (x) { [[_],[3]] -> 3; [[3],[a]] -> a; _ -> null }", (double)4);
    test("double[][] x = [[3],[4]]; switch (x) { [[_],[3]] -> 3; [[3],_] -> 4; _ -> null }", 4);
    test("double[][] x = [[3],[4]]; switch (x) { [[_],[3]] -> 3; [_,[a]] -> a; _ -> null }", (double)4);
    test("double[][] x = [[3],[4]]; switch (x) { [[_],[3]] -> 3; [_,[double a]] -> a; _ -> null }", (double)4);
    test("def x = [[3],[4]] as double[][]; switch (x) { [[_],[3]] -> 3; [[3],[a]] -> a; _ -> null }", (double)4);
    test("def x = [[3],[4]] as double[][]; switch (x) { [[_],[3]] -> 3; [[3],_] -> 4; _ -> null }", 4);
    test("def x = [[3],[4]] as double[][]; switch (x) { [[_],[3]] -> 3; [_,[a]] -> a; _ -> null }", (double)4);
    test("def x = [[3],[4]] as double[][]; switch (x) { [[_],[3]] -> 3; [_,[double a]] -> a; _ -> null }", (double)4);
    test("double[] x = [3,4]; switch (x) { [3.0D,3.0D] -> 4.0D; [3.0D,4.0D] -> 3.0D; _ -> null }", 3.0D);
    test("double[] x = [3,4]; switch (x) { [_,3.0D] -> 4.0D; [3.0D,_] -> 3.0D; _ -> null }", 3.0D);
    ...
    test("double[][] x = [[3],[4]]; switch (x) { [[_],[3.0D]] -> 3.0D; [[3.0D],[a]] -> a; _ -> null }", (double)4);
    test("double[][] x = [[3],[4]]; switch (x) { [[_],[3.0D]] -> 3.0D; [[3],[a]] -> a; _ -> null }", (double)4);
    test("double[][] x = [[3],[4]]; switch (x) { [[_],[3.0D]] -> 3.0D; [[3L],[a]] -> a; _ -> null }", (double)4);
    test("double[][] x = [[3],[4]]; switch (x) { [[_],[3.0D]] -> 3.0D; [[3.0],[a]] -> a; _ -> null }", (double)4);
    ...
    test("def x = [[3],[4]] as double[][]; switch (x) { [[_],[3.0D]] -> 3.0D; [[3],[a]] -> a; _ -> null }", (double)4);
    test("def x = [[3],[4]] as double[][]; switch (x) { [[_],[3.0D]] -> 3.0D; [[3L],[a]] -> a; _ -> null }", (double)4);
    test("def x = [[3],[4]] as double[][]; switch (x) { [[_],[3.0D]] -> 3.0D; [[3.0],[a]] -> a; _ -> null }", (double)4);
  ...
  @Test public void switchTypeDecimal() {
    test("switch (3.0) { 3 -> true; default -> false }", true);
    test("Decimal x = 3; switch (x) { 3.0 -> true; default -> false }", true);
    test("Decimal x = 3; switch (x) { 3L -> true; default -> false }", true);
    test("Decimal x = 3.0; switch (x) { 5 -> null; 3 -> true; default -> false }", true);
    test("Decimal x = 3.0; switch (x) { 5L -> null; 3.0 -> true; default -> false }", true);
    test("Decimal x = 4; switch (x) { 5 -> null; 3.0 -> true; default -> false }", false);
    ...
    test("def x = 3.0; switch (x) { 3 -> true; default -> false }", true);
    test("def x = 3.0; switch (x) { 5 -> null; 3.0 -> true; default -> false }", true);
    test("def x = 4.0; switch (x) { 5 -> null; 3 -> true; default -> false }", false);
    ...
    test("List x = [3.0]; switch (x) { [3] -> true; default -> false }", true);
    ...
    test("def x = [3.0]; switch (x) { [5] -> null; [3] -> true; default -> false }", true);
    test("def x = [4.0]; switch (x) { [5] -> null; [3.0] -> true; default -> false }", false);
    test("def x = [4.0]; switch (x) { [Decimal] -> true; [int] -> null; default -> false }", true);
    test("def x = [4.0]; switch (x) { [String] -> true; default -> false }", false);
    test("class X{}; def x = [4.0]; switch (x) { [X] -> true; default -> false }", false);
    test("package a.b; class X{}; def x = [4.0]; switch (x) { [a.b.X] -> true; default -> false }", false);
    test("Decimal[] x = [3,4]; switch (x) { [3,3] -> 4; [3,4] -> 3; _ -> null }", 3);
    test("Decimal[] x = [3,4]; switch (x) { [_,3] -> 4; [3,_] -> 3; _ -> null }", 3);
    test("Decimal[] x = [3,4]; switch (x) { [_,3] -> 3; [3,a] -> a; _ -> null }", BigDecimal.valueOf(4));
    test("def x = [3,4] as Decimal[]; switch (x) { [3,3] -> 4; [3,4] -> 3; _ -> null }", 3);
    test("def x = [3,4] as Decimal[]; switch (x) { [3,3] -> 4; [_,4] -> 3; _ -> null }", 3);
    test("def x = [3,4] as Decimal[]; switch (x) { [3,3] -> 4; [a,4] -> a; _ -> null }", BigDecimal.valueOf(3));
    testError("Decimal[][] x = [[3],[4]]; switch (x) { [_,3] -> 3; [3,a] -> a; _ -> null }", "can never match");
    test("Decimal[][] x = [[3],[4]]; switch (x) { [[_],[3]] -> 3; [[3],[a]] -> a; _ -> null }", BigDecimal.valueOf(4));
    test("Decimal[][] x = [[3],[4]]; switch (x) { [[_],[3]] -> 3; [[3],_] -> 4; _ -> null }", 4);
    test("Decimal[][] x = [[3],[4]]; switch (x) { [[_],[3]] -> 3; [_,[a]] -> a; _ -> null }", BigDecimal.valueOf(4));
    test("Decimal[][] x = [[3],[4]]; switch (x) { [[_],[3]] -> 3; [_,[Decimal a]] -> a; _ -> null }", BigDecimal.valueOf(4));
    test("def x = [[3],[4]] as Decimal[][]; switch (x) { [[_],[3]] -> 3; [[3],[a]] -> a; _ -> null }", BigDecimal.valueOf(4));
    test("def x = [[3],[4]] as Decimal[][]; switch (x) { [[_],[3]] -> 3; [[3],_] -> 4; _ -> null }", 4);
    test("def x = [[3],[4]] as Decimal[][]; switch (x) { [[_],[3]] -> 3; [_,[a]] -> a; _ -> null }", BigDecimal.valueOf(4));
    test("def x = [[3],[4]] as Decimal[][]; switch (x) { [[_],[3]] -> 3; [_,[Decimal a]] -> a; _ -> null }", BigDecimal.valueOf(4));
    test("Decimal[] x = [3,4]; switch (x) { [3.0D,3.0D] -> 4.0D; [3.0D,4.0D] -> 3.0D; _ -> null }", 3.0D);
    test("Decimal[] x = [3,4]; switch (x) { [_,3.0D] -> 4.0D; [3.0D,_] -> 3.0D; _ -> null }", 3.0D);
    test("Decimal[] x = [3,4]; switch (x) { [_,3.0D] -> 3.0D; [3.0D,a] -> a; _ -> null }", BigDecimal.valueOf(4));
    test("def x = [3,4] as Decimal[]; switch (x) { [3.0D,3.0D] -> 4.0D; [3.0D,4.0D] -> 3.0D; _ -> null }", 3.0D);
    test("def x = [3,4] as Decimal[]; switch (x) { [3.0D,3.0D] -> 4.0D; [_,4.0D] -> 3.0D; _ -> null }", 3.0D);
    test("def x = [3,4] as Decimal[]; switch (x) { [3.0D,3.0D] -> 4.0D; [a,4.0D] -> a; _ -> null }", BigDecimal.valueOf(3));
    testError("Decimal[][] x = [[3],[4]]; switch (x) { [_,3.0D] -> 3.0D; [3.0D,a] -> a; _ -> null }", "can never match");
    test("Decimal[][] x = [[3],[4]]; switch (x) { [[_],[3.0D]] -> 3.0D; [[3.0D],[a]] -> a; _ -> null }", BigDecimal.valueOf(4));
    test("Decimal[][] x = [[3],[4]]; switch (x) { [[_],[3.0D]] -> 3.0D; [[3],[a]] -> a; _ -> null }", BigDecimal.valueOf(4));
    test("Decimal[][] x = [[3],[4]]; switch (x) { [[_],[3.0D]] -> 3.0D; [[3L],[a]] -> a; _ -> null }", BigDecimal.valueOf(4));
    test("Decimal[][] x = [[3],[4]]; switch (x) { [[_],[3.0D]] -> 3.0D; [[3.0],[a]] -> a; _ -> null }", BigDecimal.valueOf(4));
    test("Decimal[][] x = [[3],[4]]; switch (x) { [[_],[3.0D]] -> 3.0D; [[3.0D],_] -> 4.0D; _ -> null }", 4.0D);
    test("Decimal[][] x = [[3],[4]]; switch (x) { [[_],[3.0D]] -> 3.0D; [_,[a]] -> a; _ -> null }", BigDecimal.valueOf(4));
    test("Decimal[][] x = [[3],[4]]; switch (x) { [[_],[3.0D]] -> 3.0D; [_,[Decimal a]] -> a; _ -> null }", BigDecimal.valueOf(4));
    test("def x = [[3],[4]] as Decimal[][]; switch (x) { [[_],[3.0D]] -> 3.0D; [[3.0D],[a]] -> a; _ -> null }", BigDecimal.valueOf(4));
    test("def x = [[3],[4]] as Decimal[][]; switch (x) { [[_],[3.0D]] -> 3.0D; [[3],[a]] -> a; _ -> null }", BigDecimal.valueOf(4));
    test("def x = [[3],[4]] as Decimal[][]; switch (x) { [[_],[3.0D]] -> 3.0D; [[3L],[a]] -> a; _ -> null }", BigDecimal.valueOf(4));
    test("def x = [[3],[4]] as Decimal[][]; switch (x) { [[_],[3.0D]] -> 3.0D; [[3.0],[a]] -> a; _ -> null }", BigDecimal.valueOf(4));
    test("def x = [[3],[4]] as Decimal[][]; switch (x) { [[_],[3.0D]] -> 3.0D; [[3.0D],_] -> 4.0D; _ -> null }", 4.0D);
    test("def x = [[3],[4]] as Decimal[][]; switch (x) { [[_],[3.0D]] -> 3.0D; [_,[a]] -> a; _ -> null }", BigDecimal.valueOf(4));
    test("def x = [[3],[4]] as Decimal[][]; switch (x) { [[_],[3.0D]] -> 3.0D; [_,[Decimal a]] -> a; _ -> null }", BigDecimal.valueOf(4));
  }
