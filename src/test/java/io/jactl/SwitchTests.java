...
public class SwitchTests extends BaseTest {
  ...
  @Test public void switchLiterals() {
    ...
    testError("int x = (byte)1; switch (x) { 1L -> 1 }", "can never match");
    testError("int x = (byte)1; switch (x) { (byte)1 -> 2 }", "can never match");
    test("byte x = (byte)1; switch (x) { (byte)1 -> 2 }", 2);
    test("def x = (byte)1; switch (x) { 1 -> 1; (byte)1 -> 2 }", 2);
    test("def x = (byte)1; switch (x) { 1 -> 1; _ -> 2 }", 2);
    ...
    test("switch ('BB') { 'Aa','BB','xxx' -> 2 }", 2);
    test("switch ('BB') { 'Aa','xxx' -> 2; 'BB' -> 1 }", 1);
  }
  ...
  @Test public void switchWithListBinding() {
    ...
    test("switch ([1,2,[3,4,5]]) { [int i, *, [_,_,*rest]] -> rest.sum() }", 5);
    test("switch ([1,2,[3,4,5]]) { [int i, *, [*rest,_]] -> rest.sum() }", 7);
    test("switch ([1,2,[3,4,5]]) { [int i, *, [*rest,_,_]] -> rest.sum() }", 3);
  ...
  @Test public void patternCoverages() {
    ...
    test("switch ([1,2,3]) { [1,2,4] -> 2; [*t] -> t.size() }", 3);
    test("switch ([1,2,3]) { [1,2,4] -> 2; [1,*t] -> t.size() }", 2);
    test("switch ([1,2,[3,4,5]]) { [1,2,4] -> 2; [1,*t] -> t.size() }", 2);
  ...
  @Test public void switchOnList() {
    ...
    test("def x = [[[(byte)3]],[[4]]] as List[][]; switch (x) { [[_],[[(byte)3]]] -> 3; [[[(byte)3]],[a]] -> a; _ -> null } == [4]", true);
    ...
    test("List[][] x = [[[3,7]],[[4,9]]]; switch (x) { [[_],[[3,*]]] -> 3; [[[3,*]],[a]] -> a; _ -> null } == [4,9]", true);
    test("List[][] x = [[[(byte)3,7]],[[4,9]]]; switch (x) { [[_],[[3,*]]] -> 3; [[[(byte)3,*]],[a]] -> a; _ -> null } == [4,9]", true);
  ...
  @Test public void switchTypeByte() {
    test("switch ((byte)3) { (byte)3 -> true; default -> false }", true);
    test("switch ((byte)-128) { (byte)-128 -> true; default -> false }", true);
    test("switch ((byte)-128) { (byte)128 -> true; default -> false }", true);
    test("switch ((byte)127) { (byte)127 -> true; default -> false }", true);
    ...
    test("byte x = 3; switch (x) { (byte)3 -> true; default -> false }", true);
    ...
    test("byte x = -3; switch (x) { (byte)5 -> null; (byte)-3 -> true; default -> false }", true);
    test("const byte x = -3; switch (x) { (byte)5 -> null; (byte)-3 -> true; default -> false }", true);
    ...
    test("def x = (byte)3; switch (x) { true -> 1; (byte)3 -> true; default -> 2 }", true);
    ...
    test("def x = (byte)-3; switch (x) { (byte)-3 -> true; default -> false }", true);
    test("def x = (byte)3; switch (x) { (byte)5 -> null; (byte)3 -> true; default -> false }", true);
    test("def x = (byte)4; switch (x) { (byte)5 -> null; (byte)3 -> true; default -> false }", false);
    ...
    test("List x = [(byte)3]; switch (x) { [(byte)3] -> true; default -> false }", true);
    test("List x = [(byte)3]; switch (x) { [3L] -> true; default -> false }", false);
    test("List x = [(byte)3]; switch (x) { [5] -> null; [(byte)3] -> true; default -> false }", true);
    ...
    test("def x = [(byte)3]; switch (x) { [(byte)3] -> true; default -> false }", true);
    test("def x = [(byte)3]; switch (x) { [true] -> null; [(byte)3] -> true; default -> false }", true);
    test("def x = [(byte)4]; switch (x) { [true] -> null; [(byte)3] -> true; default -> false }", false);
    test("def x = [(byte)4]; switch (x) { [long] -> null; [byte] -> true; default -> false }", true);
    test("def x = [(byte)4]; switch (x) { [String] -> true; default -> false }", false);
    test("class X{}; def x = [(byte)4]; switch (x) { [X] -> true; default -> false }", false);
    test("package a.b; class X{}; def x = [4]; switch (x) { [a.b.X] -> true; default -> false }", false);
    test("byte[] x = [3,4]; switch (x) { [(byte)3,(byte)3] -> 4; [(byte)3,(byte)4] -> 3; _ -> null }", 3);
    test("byte[] x = [3,4]; switch (x) { [_,(byte)3] -> 4; [(byte)3,_] -> 3; _ -> null }", 3);
    test("byte[] x = [3,4]; switch (x) { [_,(byte)3] -> 3; [(byte)3,a] -> a; _ -> null }", (byte)4);
    test("def x = [3,4] as byte[]; switch (x) { [(byte)3,(byte)3] -> 4; [(byte)3,(byte)4] -> 3; _ -> null }", 3);
    test("def x = [3,4] as byte[]; switch (x) { [3,3] -> 4; [_,(byte)4] -> 3; _ -> null }", 3);
    test("def x = [3,4] as byte[]; switch (x) { [3,3] -> 4; [a,(byte)4] -> a; _ -> null }", (byte)3);
    test("def x = [3,4] as byte[]; switch (x) { [3,3] -> 4; [byte a,(byte)4] -> a; _ -> null }", (byte)3);
    testError("byte[][] x = [[3],[4]]; switch (x) { [_,3] -> 3; [3,a] -> a; _ -> null }", "can never match");
    test("byte[][] x = [[3],[4]]; switch (x) { [[_],[(byte)3]] -> 3; [[(byte)3],[a]] -> a; _ -> null }", (byte)4);
    test("byte[][] x = [[3],[4]]; switch (x) { [[_],[(byte)3]] -> 3; [[(byte)3],_] -> 4; _ -> null }", 4);
    test("byte[][] x = [[3],[4]]; switch (x) { [[_],[(byte)3]] -> 3; [_,[a]] -> a; _ -> null }", (byte)4);
    test("byte[][] x = [[3],[4]]; switch (x) { [[_],[(byte)3]] -> 3; [_,[byte a]] -> a; _ -> null }", (byte)4);
    test("def x = [[3],[4]] as byte[][]; switch (x) { [[_],[(byte)3]] -> 3; [[(byte)3],[a]] -> a; _ -> null }", (byte)4);
    test("def x = [[3],[4]] as byte[][]; switch (x) { [[_],[(byte)3]] -> 3; [[(byte)3],_] -> 4; _ -> null }", 4);
    test("def x = [[3],[4]] as byte[][]; switch (x) { [[_],[(byte)3]] -> 3; [_,[a]] -> a; _ -> null }", (byte)4);
    test("def x = [[3],[4]] as byte[][]; switch (x) { [[_],[(byte)3]] -> 3; [_,[byte a]] -> a; _ -> null }", (byte)4);
    test("def x = [[3],[4]] as byte[][]; switch (x) { [[_],[(byte)3]] -> 3; [[a],*] -> a; _ -> null }", (byte)3);
    test("def x = [[3],[4]] as byte[][]; switch (x) { [[_],[(byte)3]] -> 3; [[_],*,[a]] -> a; _ -> null }", (byte)4);
  }
  ...
  @Test public void switchConstants() {
    ...
    testError("class X { const int A=1, B=2, C=3 }; int x = 2; switch (x) { X.A() -> 'a'; X.B -> 'b'; X.C -> 'c' }", "unknown inner class");
    test("class X { const int a=1, b=2, c=3 }; int x = 2; switch (x) { X.a -> 'a'; X.b -> 'b'; X.c -> 'c' }", "b");
