...
//  }
  ...
  @Test public void addFunctionToNewClass() {
    JactlType type = JactlContext.typeFromClass(LocalDate.class, (JactlContext)null);
    Jactl.method(type).name("testMethod").impl(RegisterClassTests.class, "testLocalDateMethod").register();
    test("LocalDate.now().testMethod()", 3);
  }

  public static int testLocalDateMethod(LocalDate localDate) {
    return 3;
  }
